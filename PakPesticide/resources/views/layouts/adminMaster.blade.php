...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <!-- Scroll to Top Button-->
    ...
    <script src="dash/vendor/datatables/dataTables.bootstrap4.js"></script>
    <!-- Custom scripts for all pages-->
    <script src="dash/js/sb-admin.min.js"></script>
    <!-- Custom scripts for this page-->
    <script src="dash/js/sb-admin-datatables.min.js"></script>
    <script src="dash/js/sb-admin-charts.min.js"></script>
</body>
</html>